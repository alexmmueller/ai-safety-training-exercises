...
**Reproduce:**
```bash
ollama pull deepseek-r1:1.5b && ollama pull qwen2.5:14b-instruct
pip install -e ~/oss/inspect-deterministic-approver   # cot_monitor.py, cot_client.py
cd cot-monitor && python cot_summarization_experiment.py
```

**Environment (A1-A8):** Python 3.11. `boolq-eval` needs `inspect_ai`,
